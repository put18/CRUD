        ...
        @csrf 
            ...
            <input type="text" name="barang" id="aplikasi" class="form-control @error('name') is-invalid @enderror">
                ...
                <input type="number" name="harga" id="aplikasi" class="form-control @error('name') is-invalid @enderror">
                    ...
                    <input type="text" name="keterangan" id="aplikasi" class="form-control @error('name') is-invalid @enderror">
                        @error('barang')
                            <div class="invalid-feedback">
                                Nama Produk tidak boleh kosong
                            </div>
                        ...
                        <input type="integer" name="kategori_id" id="aplikasi" class="form-control @error('name') is-invalid @enderror">
                            @error('barang')
                                <div class="invalid-feedback">
                                    Nama Produk tidak boleh kosong
                                </div>
